export const HERO_CONTENT = "Building scalable systems from code to cloud. DevOps & Cloud Engineer | Passionate about automating deployments, optimizing cloud infrastructure, and developing robust web applications with modern technologies.";
